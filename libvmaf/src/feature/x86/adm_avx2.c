...
static __m256i double_to_64(__m256d v) {
    ...
    __m256d v_hi_dbl     = _mm256_sub_pd(_mm256_castsi256_pd(v_hi), _mm256_set1_pd(1.9342822341709703e+25 /*2**84 + 2**63 + 2**52*/));
    ...
    for (int i = top; i < bottom; ++i)
    {
        for (int j = left; j < right_mod8; j += 8)
        {
            ...
            kd_shift_epi32 = blend(_mm256_setzero_si256(), kd_shift_epi32, mask_kd_msb_epi32);
			 ...
			 __m256i rst_h_epi32 = downconvert_64_to_32(rst_h_lo_epi64, rst_h_hi_epi64);
			 ...
			 __m256i rst_v_epi32 = downconvert_64_to_32(rst_v_lo_epi64, rst_v_hi_epi64);
			 ...
			 __m256i rst_d_epi32 = downconvert_64_to_32(rst_d_lo_epi64, rst_d_hi_epi64);

            // rst_h_f (only sign matters)
            __m256 kh_f = _mm256_cvtepi32_ps(downconvert_64_to_32(kh_lo_epi64, kh_hi_epi64));
            __m256 rst_h_f = _mm256_mul_ps(kh_f, _mm256_cvtepi32_ps(oh_epi32));
            // rst_v_f
            __m256 kv_f = _mm256_cvtepi32_ps(downconvert_64_to_32(kv_lo_epi64, kv_hi_epi64));
            __m256 rst_v_f = _mm256_mul_ps(kv_f, _mm256_cvtepi32_ps(ov_epi32));
            // rst_d_f
            __m256 kd_f = _mm256_cvtepi32_ps(downconvert_64_to_32(kd_lo_epi64, kd_hi_epi64));
            ...
            rst_h_epi32 = downconvert_64_to_32(rst_h_lo_epi64, rst_h_hi_epi64);
            ...
            rst_v_epi32 = downconvert_64_to_32(rst_v_lo_epi64, rst_v_hi_epi64);
			...
			rst_d_epi32 = downconvert_64_to_32(rst_d_lo_epi64, rst_d_hi_epi64);
